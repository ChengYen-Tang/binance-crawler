...
type IDatabase interface {
	...
	GetKlineLastTime(apiName *string, symbol *string, ctx context.Context) (*int64, error)
	GetFundingRateLastTime(apiName *string, symbol *string, ctx context.Context) (*int64, error)
